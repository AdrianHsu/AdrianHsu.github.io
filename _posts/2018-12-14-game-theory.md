...
* 優勢策略（dominant strategy）自己的所有策略中，存在某一個策略 s，無論對方選什麼、這個 s 都會比我的另一個 s' 還要好，則稱 s' is strictly dominated by s。如果所有 s' 都被我這個 s 給 S.D. 的話，那這個 s 就是 strictly dominant strategy。 
